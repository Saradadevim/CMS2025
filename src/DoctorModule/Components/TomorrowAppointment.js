...
import { fetchTomorrowAppointments } from '../services/apiService';
...
const TomorrowAppointments = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setLoading(true);
            try {
                const data = await fetchTomorrowAppointments();
                ...
                setError('Failed to fetch tomorrow\'s appointments');
        ...
        >
            ...
            <div style={{ flex: 1 }}>
                ...
                <div className="container mt-4 p-4 bg-white bg-opacity-90 rounded shadow-lg">
                    <h2 className="text-center text-primary mb-4">Tomorrow's Appointments</h2>
                    <div className="mb-4">
                        <input
                            type="text"
